...
[原文](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-context/)
...
![golang-context-usage](../../../images/go/golang-context-usage.png)
...
可以通过一个代码片段了解 [`context.Context`](https://draveness.me/golang/tree/context.Context) 是如何对信号进行同步的。在这段代码中，我们创建了一个过期时间为 1s 的上下文，并向上下文传入 `handle` 函数，该方法会使用 500ms 的时间处理传入的请求：
...
![golang-context-hierarchy](../../../images/go/golang-context-hierarchy.png)
...
![2020-01-20-15795072700927-golang-parent-cancel-context](../../../images/go/2020-01-20-15795072700927-golang-parent-cancel-context.png)

直接从 [`context.WithCancel`](https://draveness.me/golang/tree/context.WithCancel) 函数的实现来看它到底做了什么：
